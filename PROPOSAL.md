...
Video games have become an important aspect of people's lives as they provide an escape from reality and life's problems. They also provide a sense of pride and accomplishment for overcoming challenges. In the last year or so, a new genre of video games, battle royale, has taken the world by storm. Video games of this genre, like Fortnite and PUBG, are effectively last-man standing games: the last surviving player wins. These games typically involve altercations between players and heavy interaction with the game map. These features place a lot of demands on maintaining the game state, such as ensuring the validity and consistency of the world as it is modified and making sure that eliminated players are unable to further modify, but may view, the game state. In addition, as with any network game, there should be very low latency.
