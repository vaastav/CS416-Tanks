...
* StatsDiagram : This diagram shows the protocol for getting and updating statistics. It is shown in the second of the two figures below.

![Connection Diagram](connection.png){width=75%}

![Stats Diagram](stats.png){width=75%}
