...
We tested this by looking at the logs generated by GoVector and displayed in Shiviz and making sure the protocol was behaving correctly. We also tested this by making sure that each player had valid stats from the game before in the KV store which was done by reading all the files that nodes wrote to save their set of keys.
